...
import static ru.bangerok.enterprise.ninja.enumeration.Roles.ROLE_USER;
...
import ru.bangerok.enterprise.ninja.exception.auth.Oauth2AuthenticationProcessingException;
import ru.bangerok.enterprise.ninja.exception.resource.ResourceNotFoundException;
import ru.bangerok.enterprise.ninja.persistence.dao.RoleRepository;
...
import ru.bangerok.enterprise.ninja.security.oauth2.user.AbstractOauth2UserInfo;
import ru.bangerok.enterprise.ninja.security.oauth2.user.Oauth2UserInfoFactory;
